<?php
    ...
    if(!(isset($_SESSION["user"]))){
        echo "Before start donation you need to sign-in <br>";
...
<head>
    ...
    <meta name="description" content="By logging in on this page, you can start donating your unused items to those in need.">
    ...
    <link rel="stylesheet" href="./css/make-donation.css" type="text/css">
...
<body>
    ...
    <main>
        <div class="row">
            <div class="col-12">
                <h1>Make Donation</h1>
                <form action="./php/donation.php" class="donate-form" method="post" enctype="multipart/form-data" autocomplete="off">
                
                    <div class="input-wrap">
                        <label class="f-title" for="city">Which city you want to donate?</label>
                    ...
                    <div class="input-wrap">
                        <label class="f-title">How to deliver?</label>
                        <input type="radio" name="deliver" value="personally" required> Personally
                        <input type="radio" name="deliver" value="MD" id="deliver" required> Through the MD
                    </div>

                    <div class="input-wrap">
                        <label class="f-title" for="item">Donated item name</label>
                        <input type="text" id="item" name="item" class="input" placeholder="İtem name" required>
                    </div>
                    ...
                    <div class="input-wrap file-wrap">
                        <label class="f-title" for="file">Upload Your Donation Photo</label>
